---
title: "Evaluation of tcga DNN model3"
author: "Carlos Ruiz"
date: "`r Sys.Date()`"
...
In this model, we will evaluate the first configuration of the bio DNN model3 to classify TCGA samples.

```{r}
library(tidyverse)
fold <- "../results/DNN/2021-11-19/model_trained/v3/DNN_"
