---
title: "Evaluation of tcga DNN model2"
author: "Carlos Ruiz"
date: "`r Sys.Date()`"
...
In this model, we will evaluate the first configuration of the bio DNN model2 to classify TCGA samples.

```{r}
library(tidyverse)
fold <- "../results/bioDNN/2021-11-17/model_trained/v2/bioDNN_"
...
filter(report, !Category %in% c("accuracy", "macro", "weighted")) %>%
  arrange(Precision)
```
Precision ranged from 50% to 100%, depending on the cancer type, with most tumors with a precision higher than 90%. On the other hand, although recall was very low from some tumors (57%), for most tumors was higher than 90%. Performance for normal samples is very high.
...
The plot show the greatest confussion between the groups. Most READ cancer were classified as COAD, two types of colon cancer. Some confussion were also observed between LGG and GBM tumors, two types of brain cancer. Finally, ESCA tumor were wrongly classified in STAD. All nomral 