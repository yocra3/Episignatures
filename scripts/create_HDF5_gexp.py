...
f = h5py.File('results/TCGA_gexp/vsd_normassays.h5', 'r')
meth_matrix = f['assay001']
x_train = meth_matrix[...]
f.close()

with open('results/TCGA_gexp/individuals_labels.txt','r') as file:
    project = file.read()
...
f = h5py.File('results/TCGA_gexp/assay_reshaped.h5', 'w')
