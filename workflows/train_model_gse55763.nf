...
include { RANDOM_SEARCH } from '../modules/local/random_search/main.nf' addParams( options: [publish_dir: "GSE55763_model/${date}"])
include { RANDOM_SEARCH  as RANDOM_SEARCH2 } from '../modules/local/random_search/main.nf' addParams( options: [publish_dir: "GSE55763_model/${date}"])
include { TRAIN_TCGA } from '../modules/local/train_tcga/main.nf' addParams( options: [publish_dir: "GSE55763_model/${date}"])
include { PY_EXPORT_RESULTS } from '../modules/local/py_export_results/main.nf' addParams( options: [publish_dir: "GSE55763_model/${date}"])
